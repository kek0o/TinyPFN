...
def train(model: TinyPFNModel, prior: DataLoader,
    ...
    # trains model on the given prior using the given criterion, returns the trained model and a list with the eval history.
...
if __name__ == "__main__":
    ...
    }, "tinypfn_prior_trained.pt")

    print("Model saved as tinypfn_prior_trained.pt")
